...
from transformers import BertModel,BertPreTrainedModel,AutoModelForTokenClassification,RobertaForTokenClassification
...
class BertCrfForNer(RobertaForTokenClassification): #BertPreTrainedModel
    def __init__(self, config):
        ...
        self.bert =AutoModelForTokenClassification(config)#BertModel(config)
        self.dropout = nn.Dropout(config.hidden_dropout_prob)
        self.classifier = nn.Linear(config.hidden_size, config.num_labels)
